...
export async function GET(request: NextRequest) {
    ...
    // const category = searchParams.get('category'); // Exemple de filtre supplémentaire
    ...
    try {
        ...
        if (query) {
            results = MOCK_SEARCH_RESULTS.filter(product => 
                ...
                // Pourrait aussi chercher dans la description, catégorie, marque si ces données étaient ici
            );
        }
